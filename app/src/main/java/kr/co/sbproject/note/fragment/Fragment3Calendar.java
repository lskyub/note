...
public class Fragment3Calendar extends FlowFragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        setInit(Common.Key.FRAGMENT_CALENDAR);
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment3_calendar, container, false);
    }
